...
public class Produto {
    ...
    //Foi feito uma refatoracão dos métodos assessores para poder ir setando os valores sequencialmente,
    //e assim não se torna necessário ficar usando a variável varias vezes. Com isso, nós ganhamos agilidade para
    //criacão e instanciacão dos objetos.
    public Long getId() {
        return id;
    }
